 ...
 */
public class RNECEncryptionModule extends ReactContextBaseJavaModule {
  private static final String KEYSTORE_PROVIDER_NAME = "rnecencryption.keystore";
  private static final String SHARED_PREF_FILE_NAME = "rnecencryption.shared.pref";
  ...
  public RNECEncryptionModule(ReactApplicationContext reactContext) {
    super(reactContext);
    try {
      HybridConfig.init();
    } catch (GeneralSecurityException ex) {
      Log.e("init RNECEncryption Module", "ERR", ex);
    }
  }
  ...
  public void encrypt(ReadableMap map, Promise promise) {
    try {
      ...
      Log.e("RNECEncryption", "encryption error", e);
      promise.reject("RNECEncryption error", e);
      return;
    }
  }
  ...
  public void decrypt(ReadableMap map, Promise promise) {
    try {
      ...
      Log.e("RNECEncryption", "decrypt error", e);
      promise.reject("RNECEncryption error", e);
      return;
    }
  }
